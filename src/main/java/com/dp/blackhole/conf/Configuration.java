...
public class Configuration {
    ...
    public static Map<String, Context> appConfigMap = new HashMap<String, Context>();
    ...
    public boolean addRawProperty(String name, String value) {
        ...
        if (!appConfigMap.containsKey(appName)) {
          appConfigMap.put(appName, new Context(configKey, value));
        } else {
          appConfigMap.get(appName).put(configKey, value);
        }
