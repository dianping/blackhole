...
public class TransferThrottler {
     ...
     */
    public TransferThrottler(long bandwidthPerSec) {
        this(1000, bandwidthPerSec); // by default throttling period is 500ms
    }
     ...
     *            bandwidth allowed in bytes per second.
     */
    public TransferThrottler(long period, long bandwidthPerSec) {
